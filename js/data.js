...
const SITE_DATA = {
  ...
  ui: {
    ko: {
      ...
      audioHint: "▶ AUDIO 버튼을 누르면 배경 비주얼이 음악에 반응합니다. <b>assets/audio/track.mp3</b>에 음원을 넣어주세요. (파일이 없으면 기본 애니메이션으로 동작)",
    ...
    en: {
      ...
      audioHint: "Press ▶ AUDIO to make the visuals react to music. Drop your track at <b>assets/audio/track.mp3</b>. (Falls back to idle animation without it)",
